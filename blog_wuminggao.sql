...
CREATE TABLE `t_blog` (
  ...
  `appreciation` int(1) NOT NULL DEFAULT '0',
  `share_statement` int(1) NOT NULL DEFAULT '0',
...
CREATE TABLE `t_comment` (
  ...
  `admin_comment` int(1) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES (1, 'wuminggao', 'wuminggao', 'e10adc3949ba59abbe56e057f20f883e', 'wuminggao594@foxmail.com', 'avatar_address', 1, '2020-03-08 18:25:26', NULL);
